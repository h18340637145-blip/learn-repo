...
- [ ] **步骤 3：扩展 QuestionType、CodeLanguage 和 VisualizerType**
...
- [ ] **步骤 3：保持 Node.js / Next.js 阶段数特殊规则**
...
- [ ] **步骤 2：检查 `scripts/validate-curriculum.ts`**
