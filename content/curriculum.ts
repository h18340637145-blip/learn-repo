...
export const curriculum = [
  ...
  stage("files-streams", 4, "文件、Buffer 与 Stream", "高效处理本地数据", [
    ...
    ["files-glob-patterns", "glob 与批量文件匹配"],
    ["files-temp-workspace", "临时目录与工作区清理"],
    ["buffer-binary-protocol", "Buffer 与二进制协议"],
    ["buffer-base64-json", "Base64 与 JSON 载荷"],
    ["streams-duplex", "Duplex Stream 双向通道"],
    ["streams-error-handling", "Stream 错误处理"],
    ["streams-line-parser", "按行解析日志流"]
