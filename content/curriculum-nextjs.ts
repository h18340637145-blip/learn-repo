...
const publishedIds = new Set([
  ...
  "nextjs-routing-dynamic",
  "nextjs-routing-groups",
  "nextjs-routing-parallel",
  "nextjs-routing-intercepting",
  "nextjs-routing-loading",
  "nextjs-routing-error",
  "nextjs-routing-not-found",
  "nextjs-routing-middleware",
  "project-nextjs-blog-nav",
  "nextjs-rendering-ssr",
  "nextjs-rendering-ssg",
  "nextjs-rendering-isr",
  "nextjs-rendering-streaming",
  "nextjs-rendering-suspense",
  "nextjs-rendering-sc-vs-cc",
  "nextjs-rendering-partial",
  "nextjs-rendering-cache",
  "project-nextjs-news-aggregator",
  "nextjs-data-server-fetch",
  "nextjs-data-cache",
  "nextjs-data-revalidate",
  "nextjs-data-server-actions",
  "nextjs-data-form-status",
  "nextjs-data-action-state",
  "nextjs-data-parallel-loading",
  "nextjs-data-error-handling",
  "project-nextjs-task-crud",
  "nextjs-style-css-modules",
  "nextjs-style-tailwind",
  "nextjs-style-font",
  "nextjs-style-image",
  "nextjs-style-link",
  "nextjs-style-metadata",
  "nextjs-style-og-image",
  "nextjs-style-bundle",
  "project-nextjs-portfolio",
  "nextjs-api-route-handler",
  "nextjs-api-request-response",
  "nextjs-api-dynamic-routes",
  "nextjs-api-middleware",
  "nextjs-api-rewrite-redirect",
  "nextjs-api-cors",
  "nextjs-api-streaming",
  "nextjs-api-edge-runtime",
  "project-nextjs-api-gateway",
  "nextjs-auth-concepts",
  "nextjs-auth-nextauth",
  "nextjs-auth-jwt-session",
  "nextjs-auth-protected-routes",
  "nextjs-auth-middleware-guard",
  "nextjs-auth-rbac",
  "nextjs-auth-oauth",
  "nextjs-auth-security",
  "project-nextjs-login-system",
  "nextjs-db-prisma-setup",
  "nextjs-db-schema-migration",
  "nextjs-db-crud-operations",
  "nextjs-db-server-actions-db",
  "nextjs-db-transactions",
  "nextjs-db-connection-pool",
  "nextjs-db-drizzle",
  "nextjs-db-seed-data",
  "project-nextjs-guestbook",
  "nextjs-test-unit",
  "nextjs-test-rtl",
  "nextjs-test-e2e",
  "nextjs-test-api",
  ...
  "nextjs-deploy-env",
  "nextjs-deploy-preview",
  "nextjs-deploy-ci",
  "project-nextjs-test-suite",
  "nextjs-advanced-i18n",
  "nextjs-advanced-optimistic",
  "nextjs-advanced-realtime",
  "nextjs-advanced-edge",
  "nextjs-advanced-isr-demand",
  "nextjs-advanced-compose",
  "nextjs-advanced-monorepo",
  "nextjs-advanced-performance",
  "project-nextjs-realtime-dashboard"
]);
